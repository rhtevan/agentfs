...
## 2026-09-09 21:21
- Updated base_url from localhost to host.containers.internal in three provider skills: goose-litellm-provider v1.7.0 (restore.sh, verify.sh, SKILL.md); goose-skupper-provider v5.4.0 (setup.sh, SKILL.md); goose-headroom-provider v2.1.0 (SKILL.md). Enables dual-resolution: host resolves to 127.0.0.1, containers resolve to 169.254.1.2.
