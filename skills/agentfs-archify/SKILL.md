...
description: >
  ...
  create lifecycle diagram, visualize architecture,
  map architecture, convert mermaid, beautify mermaid
license: MIT
metadata:
  version: "2.15"
  author: tt-a1i
  based_on: Cocoon-AI/architecture-diagram-generator (MIT, v1.0)
  tags: [visualization, diagrams, architecture, workflow, sequence, dataflow, lifecycle, mermaid, html]
---
...
|---------|---------|----------|
| Working directory | Current project root (`./`) | Explicit user path |
| Output location | `docs/` (relative to working directory) | Explicit user path |
| File naming | `<name>.<type>.html` (e.g., `system.architecture.html`) | Explicit user filename |
