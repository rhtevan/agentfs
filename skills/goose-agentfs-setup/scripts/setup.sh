...
`cognee__remember`, `cognee__recall`, `cognee__forget`,
`memory__remember_memory`, `memory__retrieve_memories`,
`memory__remove_specific_memory`, `memory__remove_memory_category`,
`chatrecall` — load the full routing table:
